...
help:
	@echo "======================================================="
	@echo "       🚀 RISC-V 5-STAGE PIPELINE BUILD SYSTEM 🚀"
	@echo "======================================================="
	@echo ""
	@echo "🌟 Quick Test (just pick one!):"
	@for t in $(ASM_TESTS); do \
		echo "  make test_$$t"; \
	done
	@echo ""
	@echo "🔧 Build Flow (.s → .o → .bin → .mem → Verilator):"
	@echo "  make all   TEST=<name> : Full flow (assemble + compile + simulate)"
	@echo "  make asm   TEST=<name> : Only assemble .s to .mem"
	@echo "  make build TEST=<name> : Assemble + Verilator compile"
	@echo "  make sim   TEST=<name> : Full flow with simulation"
	@echo ""
	@echo "🛠️  Utilities:"
	@echo "  make disasm TEST=<name> : View disassembly of test"
	@echo "  make list_tests         : List all available .s tests"
	...
	@echo "📌 Sample Runs:"
	@echo "  ┌──────────────────────────────────────────────────────┐"
	@echo "  │ # Run hazard test (default)                          │"
	@echo "  │ $$ make test_testcase_hazards                        │"
	@echo "  │                                                      │"
	@echo "  │ # Run all ALU operations test                        │"
	@echo "  │ $$ make test_testcase_alu                            │"
	@echo "  │                                                      │"
	@echo "  │ # Only assemble (no simulation)                      │"
	@echo "  │ $$ make asm TEST=testcase_branch                     │"
	@echo "  │                                                      │"
	@echo "  │ # View generated machine code                        │"
	@echo "  │ $$ make disasm TEST=testcase_hazards                 │"
	@echo "  │                                                      │"
	@echo "  │ # Clean and rebuild from scratch                     │"
	@echo "  │ $$ make clean && make test_testcase_hazards          │"
	@echo "  │                                                      │"
	@echo "  │ # Add your own test: create sim/asm/my_test.s        │"
